 ...
 * @license MIT
 */
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.postmanBDD=f()}})(function(){var define,module,exports;return function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s}({1:[function(require,module,exports){"use strict";function chaiHttp(e,t){function o(e){var t=contentTypes[e];s.addProperty(e,function(){var o=getHeader(this._obj,"content-type");this.assert(o&&o.indexOf(t)>=0,"expected the response type to be #{exp} but got #{act}","expected the response type to not be #{exp} (#{act})",e,o||"<content-type-not-set>")})}var s=e.Assertion;s.addMethod("status",function(e){new s(this._obj).to.have.property("status");var t=this._obj.status;this.assert(t===e,"expected the response to have status code #{exp} but got #{act}","expected the response to not have status code #{act}",e,t)}),s.addProperty("headers",function(){this.assert(Object.keys(this._obj.header||{}).length>0,"expected the response to have headers","expected the response to not have headers")}),s.addMethod("header",function(e,t){var o=getHeader(this._obj,e),s=void 0!==o&&null!==o;arguments.length<2?this.assert(s,"expected header #{exp} to exist","expected header #{exp} to not exist",e,o):t instanceof RegExp?this.assert(s&&t.test(o),"expected header '"+e+"' to match #{exp} but got #{act}","expected header '"+e+"' to not match #{exp} but got #{act}",t,s?o:"<header-not-set>"):this.assert(s&&o===t,"expected header '"+e+"' to have value #{exp} but got #{act}","expected header '"+e+"' to not have value #{exp}",t,s?o:"<header-not-set>")}),s.addProperty("ip",function(){this.assert(isIP(this._obj),"expected #{this} to be an ip","expected #{this} to not be an ip")}),Object.keys(contentTypes).forEach(o),s.addProperty("redirect",function(){var e=this._obj.status;this.assert(wasRedirected(this._obj),"expected redirect status code but got "+e,"expected not to redirect but got "+e+" status")}),s.addMethod("redirectTo",function(e){var t=this._obj.redirects,o=wasRedirected(this._obj),s=this._obj.status,r=getHeader(this._obj,"location");t&&t.length?this.assert(t.indexOf(e)>-1,"expected redirect to "+e+" but got "+t.join(" then "),"expected not to redirect to "+e+" but got "+t.join(" then ")):this.assert(o&&r===e,"expected redirect to #{exp} but got #{act}","expected not to redirect to #{exp}",e,o?r:s)}),s.addMethod("param",function(e,o){var r=new s;t.transferFlags(this,r),r._obj=qs.parse(url.parse(this._obj.url).query),1===arguments.length?r.property(e):r.property(e,o)}),s.addMethod("cookie",function(e,t){var o=getCookie(this._obj,e);2===arguments.length?this.assert(o.value===t,"expected cookie '"+e+"' to have value #{exp} but got #{act}","expected cookie '"+e+"' to not have value #{exp}",t,o.value):this.assert("undefined"!=typeof o||null===o,"expected cookie '"+e+"' to exist","expected cookie '"+e+"' to not exist")}),e.Assertion.addMethod("schema",function(e){var t=tv4.validate(this._obj,e);if(!t)throw tv4.error})}function getHeader(e,t){if(e.getHeader)return e.getHeader(t);t=(t||"").toLowerCase();for(var o=Object.keys(e.headers),s=0;s<o.length;s++)if(o[s].toLowerCase()===t)return e.headers[o[s]]}function getCookie(e,t){if(e.getCookie)return e.getCookie(t);var o=getHeader(e,"set-cookie");o||(o=(getHeader(e,"cookie")||"").split(";"));var s=Cookie.CookieJar();return s.setCookies(o),s.getCookie(t,new Cookie.CookieAccessInfo)}function wasRedirected(e){var t=[301,302,303,307,308],o=e.redirects,s=e.status;return t.indexOf(s)>=0||o&&o.length}var isIP=require("is-ip"),qs=require("qs"),url=require("url"),Cookie=require("cookiejar"),contentTypes={json:"application/json",text:"text/plain",html:"text/html"};module.exports=chaiHttp},{cookiejar:46,"is-ip":47,qs:50,url:62}],2:[function(require,module,exports){"use strict";function PostmanBDD(){var t=this.state=new State;this.hooks={before:new Hook("before",t),after:new Hook("after",t),beforeEach:new Hook("beforeEach",t),afterEach:new Hook("afterEach",t)},this.before=PostmanBDD.prototype.before.bind(this),this.after=PostmanBDD.prototype.after.bind(this),this.beforeEach=PostmanBDD.prototype.beforeEach.bind(this),this.afterEach=PostmanBDD.prototype.afterEach.bind(this),this.describe=PostmanBDD.prototype.describe.bind(this),this.it=PostmanBDD.prototype.it.bind(this)}var Runnable=require("./runnable"),Hook=require("./hook"),State=require("./state");module.exports=PostmanBDD,PostmanBDD.prototype.before=function(t,e){this.hooks.before.push(t,e)},PostmanBDD.prototype.after=function(t,e){this.hooks.after.push(t,e)},PostmanBDD.prototype.beforeEach=function(t,e){this.hooks.beforeEach.push(t,e)},PostmanBDD.prototype.afterEach=function(t,e){this.hooks.afterEach.push(t,e)},PostmanBDD.prototype.describe=function(t,e){this.oneTimeInitialization();var o=new Runnable("describe",this.state,t,e);return o.run(),this.state.isFinished()&&this.hooks.after.run(),this.state.results},PostmanBDD.prototype.it=function(t,e){this.oneTimeInitialization(),this.hooks.beforeEach.run();var o=new Runnable("it",this.state,t,e);return o.run(),this.hooks.afterEach.run(),o.result},PostmanBDD.prototype.oneTimeInitialization=function(){this.state.isStarted()||this.hooks.before.run()}},{"./hook":3,"./runnable":8,"./state":9}],3:[function(require,module,exports){"use strict";function Hook(t,n){this.type=t,this.state=n,this.runnables=[]}var Runnable=require("./runnable");module.exports=Hook,Hook.prototype.run=function(){this.state.inAHook()||this.runnables.forEach(function(t){t.run()})},Hook.prototype.push=function(t,n){var o=new Runnable(this.type,this.state,t,n);o.isHook=!0,this.runnables.push(o)}},{"./runnable":8}],4:[function(require,module,exports){function initPostmanBDD(){log.info("Using Postman BDD"),initBDD(),initSuperAgent(),initChai()}function initBDD(){var e=new PostmanBDD;before=e.before,after=e.after,beforeEach=e.beforeEach,afterEach=e.afterEach,describe=e.describe,it=e.it}function initSuperAgent(){var e=new SuperAgent;response=e.response}function initChai(){chai=require("chai"),assert=chai.assert,expect=chai.expect,chai.should(),chai.use(assertions)}var PostmanBDD=require("./bdd"),SuperAgent=require("./response"),assertions=require("./assertions"),options=require("./options"),log=require("./log");module.exports=options,module.exports.reset=initPostmanBDD,initPostmanBDD()},{"./assertions":1,"./bdd":2,"./log":5,"./options":6,"./response":7,chai:10}],5:[function(require,module,exports){"use strict";var options=require("./options"),levels=["silent","error","warn","info","debug"],log=module.exports={isEnabled:function(e){return levels.indexOf(options.logLevel)>=levels.indexOf(e)}};levels.forEach(function(e){log[e]=function(){if(this.isEnabled(e)){var o=console.log;"function"==typeof console[e]&&(o=console[e]),o.apply(console,arguments)}}})},{"./options":6}],6:[function(require,module,exports){"use strict";module.exports={logLevel:"warn"}},{}],7:[function(require,module,exports){"use strict";function defineProperties(e,t){Object.keys(t).forEach(function(n){Object.defineProperty(e,n,{configurable:!0,enumerable:!0,get:t[n]})})}function getResponseHeader(e){if("object"==typeof postman&&"function"==typeof postman.getResponseHeader)return postman.getResponseHeader(e)}function getResponseCookie(e){if("object"==typeof postman&&"function"==typeof postman.getResponseCookie)return postman.getResponseCookie(e)}module.exports=function(){var e=this;e.response={getHeader:function(t){return t=(t||"").toLowerCase(),getResponseHeader(t)||e.response.header[t]},getCookie:function(e){return getResponseCookie(e)}},defineProperties(e.response,{status:function(){return"object"==typeof responseCode?responseCode.code:0},statusType:function(){return Math.floor(e.response.status/100)},info:function(){return 1===e.response.statusType},ok:function(){return 2===e.response.statusType},redirect:function(){return 3===e.response.statusType},clientError:function(){return 4===e.response.statusType},serverError:function(){return 5===e.response.statusType},error:function(){return e.response.clientError||e.response.serverError},accepted:function(){return 202===e.response.status},noContent:function(){return 204===e.response.status||1223===e.response.status},badRequest:function(){return 400===e.response.status},unauthorized:function(){return 401===e.response.status},notAcceptable:function(){return 406===e.response.status},notFound:function(){return 404===e.response.status},forbidden:function(){return 403===e.response.status},text:function(){return"string"==typeof responseBody?responseBody:""},body:function(){try{return JSON.parse(e.response.text)}catch(e){return{}}},header:function(){return"object"==typeof responseHeaders?responseHeaders:{}},headers:function(){return"object"==typeof responseHeaders?responseHeaders:{}},time:function(){return"number"==typeof responseTime?responseTime:0},type:function(){var t=e.response.getHeader("content-type")||"";return t.split(";")[0]},charset:function(){var t=e.response.getHeader("content-type")||"",n=/charset=([a-zA-Z0-9_-]+)/i.exec(t);return n?n[1]:""}})}},{}],8:[function(require,module,exports){"use strict";function Runnable(t,s,e,i){"function"==typeof e&&(i=e,e=""),this.type=t,this.state=s,this.isHook=!1,this.title=e,this.fn=i,this.result=null,this.error=null}function errorToPOJO(t){if(t&&"object"==typeof t)return Object.keys(t).concat(["name","message","stack"]).reduce(function(s,e){return s[e]=t[e],s},{})}var log=require("./log");module.exports=Runnable,Runnable.prototype.run=function(){this.state.counters[this.type]++,this.title=this.title||("it"===this.type?"test":this.type)+" #"+this.state.counters[this.type],this.state.stack.push(this);var t=this.state.stack.toString();log.debug("Running "+t);try{this.fn(),this.success(t)}catch(s){this.failure(s,t)}finally{this.state.stack.pop()}},Runnable.prototype.success=function(t){log.info("passed: "+t),this.result=!0,"it"===this.type&&(this.state.results[t||this.title]=!0)},Runnable.prototype.failure=function(t,s){log.error("failed: "+s,errorToPOJO(t)),this.result=!1,this.error=t,this.state.results[s||this.title]=!1,this.state.results[t.message]=!1}},{"./log":5}],9:[function(require,module,exports){"use strict";function State(){this.results=resetTests(),this.stack=[],this.counters={describe:0,it:0,before:0,after:0,beforeEach:0,afterEach:0},this.stack.toString=function(){return this.map(function(t){return t.title}).join(" ")}}function resetTests(){if("object"!=typeof tests)throw new Error('Postman BDD can only run inside the Postman scripting runtime (the "tests" global variable is missing)');return Object.keys(tests).forEach(function(t){delete tests[t]}),tests}module.exports=State,State.prototype.isStarted=function(){var t=this;return this.stack.length>0||Object.keys(this.counters).some(function(e){return t.counters[e]>0})},State.prototype.isFinished=function(){return 0===this.stack.length&&this.counters.describe>0},State.prototype.inAHook=function(){return this.stack.some(function(t){return t.isHook})}},{}],10:[function(require,module,exports){module.exports=require("./lib/chai")},{"./lib/chai":11}],11:[function(require,module,exports){/*!
 * chai
 ...
 * Assert interface
 */
var assert=require("./chai/interface/assert");exports.use(assert)},{"./chai/assertion":12,"./chai/config":13,"./chai/core/assertions":14,"./chai/interface/assert":15,"./chai/interface/expect":16,"./chai/interface/should":17,"./chai/utils":31,"assertion-error":39}],12:[function(require,module,exports){/*!
 * chai
 * http://chaijs.com
 * Copyright(c) 2011-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 ...
 * @api private
 */
function _getPathValue(e,r,a){var t,n=r;a=void 0===a?e.length:a;for(var p=0,u=a;p<u;p++){var o=e[p];n?("undefined"!=typeof o.p?n=n[o.p]:"undefined"!=typeof o.i&&(n=n[o.i]),p==u-1&&(t=n)):t=void 0}return t}var hasProperty=require("./hasProperty");module.exports=function(e,r){var a=parsePath(e),t=a[a.length-1],n={parent:a.length>1?_getPathValue(a,r,a.length-1):r,name:t.p||t.i,value:_getPathValue(a,r)};return n.exists=hasProperty(n.name,n.parent),n}},{"./hasProperty":30}],28:[function(require,module,exports){/*!
 * Chai - getPathValue utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * @see https://github.com/logicalparadox/filtr
 * MIT Licensed
 */
var getPathInfo=require("./getPathInfo");module.exports=function(e,t){var r=getPathInfo(e,t);return r.value}},{"./getPathInfo":27}],29:[function(require,module,exports){/*!
 * Chai - getProperties utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
module.exports=function(e){function t(e){o.indexOf(e)===-1&&o.push(e)}for(var o=Object.getOwnPropertyNames(e),r=Object.getPrototypeOf(e);null!==r;)Object.getOwnPropertyNames(r).forEach(t),r=Object.getPrototypeOf(r);return o}},{}],30:[function(require,module,exports){/*!
 * Chai - hasProperty utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
var type=require("type-detect"),literals={number:Number,string:String};module.exports=function(e,t){var r=type(t);return"null"!==r&&"undefined"!==r&&(literals[r]&&"object"!=typeof t&&(t=new literals[r](t)),e in t)}},{"type-detect":44}],31:[function(require,module,exports){/*!
 * chai
 ...
 * Module dependancies
 */
var inspect=require("./inspect"),config=require("../config");module.exports=function(e){var n=inspect(e),t=Object.prototype.toString.call(e);if(config.truncateThreshold&&n.length>=config.truncateThreshold){if("[object Function]"===t)return e.name&&""!==e.name?"[Function: "+e.name+"]":"[Function]";if("[object Array]"===t)return"[ Array("+e.length+") ]";if("[object Object]"===t){var r=Object.keys(e),c=r.length>2?r.splice(0,2).join(", ")+", ...":r.join(", ");return"{ Object ("+c+") }"}return n}return n}},{"../config":13,"./inspect":32}],34:[function(require,module,exports){/*!
 * Chai - overwriteChainableMethod utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
module.exports=function(i,t,n,o){var h=i.__methods[t],r=h.chainingBehavior;h.chainingBehavior=function(){var i=o(r).call(this);return void 0===i?this:i};var a=h.method;h.method=function(){var i=n(a).apply(this,arguments);return void 0===i?this:i}}},{}],35:[function(require,module,exports){/*!
 * Chai - overwriteMethod utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
module.exports=function(t,n,i){var o=t[n],r=function(){return this};o&&"function"==typeof o&&(r=o),t[n]=function(){var t=i(r).apply(this,arguments);return void 0===t?this:t}}},{}],36:[function(require,module,exports){/*!
 * Chai - overwriteProperty utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
module.exports=function(t,e,n){var o=Object.getOwnPropertyDescriptor(t,e),r=function(){};o&&"function"==typeof o.get&&(r=o.get),Object.defineProperty(t,e,{get:function(){var t=n(r).call(this);return void 0===t?this:t},configurable:!0})}},{}],37:[function(require,module,exports){/*!
 * Chai - test utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
 ...
 * Module dependancies
 */
var flag=require("./flag");module.exports=function(e,r){var a=flag(e,"negate"),f=r[0];return a?!f:f}},{"./flag":22}],38:[function(require,module,exports){/*!
 * Chai - transferFlags utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
module.exports=function(e,l,a){var s=e.__flags||(e.__flags=Object.create(null));l.__flags||(l.__flags=Object.create(null)),a=3!==arguments.length||a;for(var _ in s)(a||"object"!==_&&"ssfi"!==_&&"message"!=_)&&(l.__flags[_]=s[_])}},{}],39:[function(require,module,exports){/*!
 * assertion-error
 ...
 * Primary Export
 */
module.exports=deepEqual},{buffer:54,"type-detect":42}],42:[function(require,module,exports){module.exports=require("./lib/type")},{"./lib/type":43}],43:[function(require,module,exports){/*!
 * type-detect
 * Copyright(c) 2013 jake luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
