...
"use strict";var isIP=require("is-ip"),qs=require("qs"),url=require("url"),Cookie=require("cookiejar");module.exports=function(e,t){function o(e,t){if(e.getHeader)return e.getHeader(t);t=t.toLowerCase();for(var o=Object.keys(e.headers),s=0;s<o.length;s++)if(o[s].toLowerCase()===t)return e.headers[o[s]]}function s(e,t){if(e.getCookie)return e.getCookie(t);var s=o(e,"set-cookie");s||(s=(o(e,"cookie")||"").split(";"));var r=Cookie.CookieJar();return r.setCookies(s),r.getCookie(t,new Cookie.CookieAccessInfo)}function r(e){var s=a[e];i.addProperty(e,function(){new i(this._obj).to.have.headers;var e=o(this._obj,"content-type"),r="undefined"===t.inspect(e)?"headers":t.inspect(e);this.assert(e&&e.indexOf(s)>=0,"expected "+r+" to include '"+s+"'","expected "+r+" to not include '"+s+"'")})}var i=e.Assertion,a={json:"application/json",text:"text/plain",html:"text/html"};i.addMethod("status",function(e){new i(this._obj).to.have.property("status");var t=this._obj.status;this.assert(t===e,"expected #{this} to have status code #{exp} but got #{act}","expected #{this} to not have status code #{act}",e,t)}),i.addMethod("header",function(e,s){var r=o(this._obj,e);arguments.length<2?this.assert("undefined"!=typeof r||null===r,"expected header '"+e+"' to exist","expected header '"+e+"' to not exist"):s instanceof RegExp?this.assert(s.test(r),"expected header '"+e+"' to match "+s+" but got "+t.inspect(r),"expected header '"+e+"' not to match "+s+" but got "+t.inspect(r),s,r):this.assert(r===s,"expected header '"+e+"' to have value "+s+" but got "+t.inspect(r),"expected header '"+e+"' to not have value "+s,s,r)}),i.addProperty("headers",function(){this.assert("function"==typeof this._obj.getHeader||Object.keys(this._obj.headers||{}).length>0,"expected #{this} to have headers or getHeader method","expected #{this} to not have headers or getHeader method")}),i.addProperty("ip",function(){this.assert(isIP(this._obj),"expected #{this} to be an ip","expected #{this} to not be an ip")}),Object.keys(a).forEach(r),i.addProperty("redirect",function(){var e=[301,302,303],t=this._obj.status,o=this._obj.redirects;this.assert(e.indexOf(t)>=0||o&&o.length,"expected redirect with 30{1-3} status code but got "+t,"expected not to redirect but got "+t+" status")}),i.addMethod("redirectTo",function(e){var o=this._obj.redirects;if(new i(this._obj).to.redirect,o&&o.length)this.assert(o.indexOf(e)>-1,"expected redirect to "+e+" but got "+o.join(" then "),"expected not to redirect to "+e+" but got "+o.join(" then "));else{var s=new i(this._obj);t.transferFlags(this,s),s["with"].header("location",e)}}),i.addMethod("param",function(e,o){var s=new i;t.transferFlags(this,s),s._obj=qs.parse(url.parse(this._obj.url).query),s.property.apply(s,arguments)}),i.addMethod("cookie",function(e,t){var o=s(this._obj,e);2===arguments.length?this.assert(o.value===t,"expected cookie '"+e+"' to have value #{exp} but got #{act}","expected cookie '"+e+"' to not have value #{exp}",t,o.value):this.assert("undefined"!=typeof o||null===o,"expected cookie '"+e+"' to exist","expected cookie '"+e+"' to not exist")}),e.Assertion.addMethod("schema",function(e){var t=tv4.validate(this._obj,e);if(!t)throw tv4.error})};

},{"cookiejar":45,"is-ip":52,"qs":55,"url":64}],3:[function(require,module,exports){
var Runnable=require("./runnable"),Hook=require("./hook"),state=require("./state"),globals=require("./globals"),hooks={};["before","after","beforeEach","afterEach"].forEach(function(e){var r=hooks[e]=new Hook(e),o=globals.register(e,r.push.bind(r));o.pop=r.pop.bind(r),o.clear=r.clear.bind(r),o.count=r.count.bind(r)}),globals.register("describe",function(e,r){0===state.stack.length&&(state.reset(),globals.restore(),hooks.before.run());var o=new Runnable("describe",e,r);return o.run(),0===state.stack.length&&hooks.after.run(),state.results}),globals.register("it",function(e,r){hooks.beforeEach.run();var o=new Runnable("it",e,r);return o.run(),hooks.afterEach.run(),o.result});

},{"./globals":4,"./hook":5,"./runnable":9,"./state":11}],4:[function(require,module,exports){
(function (global){
var runtime=require("./runtime"),state=require("./state"),chai=require("chai"),globalNames=[],globalValues="undefined"==typeof _?global:_,globalScope=runtime.newman?this:global;module.exports={register:function(e,l){return-1===globalNames.indexOf(e)&&globalNames.push(e),globalValues[e]=l,globalScope[e]=l,l},restore:function(){globalNames.forEach(function(e){globalScope[e]=globalValues[e]}),chai.should(),state.results="object"==typeof tests?tests:{}}};

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./runtime":10,"./state":11,"chai":16}],5:[function(require,module,exports){
"use strict";function Hook(n){this.name=n,this.runnables=[]}var Runnable=require("./runnable"),state=require("./state");module.exports=Hook,Hook.prototype.run=function(){state.inAHook()||this.runnables.forEach(function(n){n.run()})},Hook.prototype.push=function(n,o){var t=new Runnable(this.name,n,o);t.isHook=!0,this.runnables.push(t)},Hook.prototype.pop=function(){this.runnables.pop()},Hook.prototype.clear=function(){this.runnables=[]},Hook.prototype.count=function(){return this.runnables.length};

},{"./runnable":9,"./state":11}],6:[function(require,module,exports){
"use strict";require("./_prelude"),require("./bdd");var globals=require("./globals");globals.register("postmanBDD",globals.restore),module.exports=require("./options"),globals.register("response",require("./response"));var chai=globals.register("chai",require("chai"));globals.register("assert",chai.assert),globals.register("expect",chai.expect),chai.should();var assertions=require("./assertions");chai.use(assertions);

},{"./_prelude":1,"./assertions":2,"./bdd":3,"./globals":4,"./options":7,"./response":8,"chai":16}],7:[function(require,module,exports){
"use strict";var runtime=require("./runtime");module.exports={debug:!0,log:!runtime.newman};

},{"./runtime":10}],8:[function(require,module,exports){
function getPostman(){return"object"==typeof postman?postman:postmanProxy}module.exports=Object.defineProperties({},{text:{configurable:!0,enumerable:!0,get:function(){return"string"==typeof responseBody?responseBody:""}},body:{configurable:!0,enumerable:!0,get:function(){try{return JSON.parse(this.text)}catch(e){return{}}}},headers:{configurable:!0,enumerable:!0,get:function(){return"object"==typeof responseHeaders?responseHeaders:{}}},time:{configurable:!0,enumerable:!0,get:function(){return"number"==typeof responseTime?responseTime:0}},type:{configurable:!0,enumerable:!0,get:function(){var e=this.getHeader("content-type")||"";return e.split(";")[0]}},charset:{configurable:!0,enumerable:!0,get:function(){var e=this.getHeader("content-type")||"",t=/charset=([a-zA-Z0-9_-]+)/i.exec(e);return t?t[1]:""}},status:{configurable:!0,enumerable:!0,get:function(){return"object"==typeof responseCode?responseCode.code:0}},statusType:{configurable:!0,enumerable:!0,get:function(){return Math.floor(this.status/100)}},info:{configurable:!0,enumerable:!0,get:function(){return 1===this.statusType}},ok:{configurable:!0,enumerable:!0,get:function(){return 2===this.statusType}},clientError:{configurable:!0,enumerable:!0,get:function(){return 4===this.statusType}},serverError:{configurable:!0,enumerable:!0,get:function(){return 5===this.statusType}},error:{configurable:!0,enumerable:!0,get:function(){return this.clientError||this.serverError}},accepted:{configurable:!0,enumerable:!0,get:function(){return 202===this.status}},noContent:{configurable:!0,enumerable:!0,get:function(){return 204===this.status||1223===this.status}},badRequest:{configurable:!0,enumerable:!0,get:function(){return 400===this.status}},unauthorized:{configurable:!0,enumerable:!0,get:function(){return 401===this.status}},notAcceptable:{configurable:!0,enumerable:!0,get:function(){return 406===this.status}},notFound:{configurable:!0,enumerable:!0,get:function(){return 404===this.status}},forbidden:{configurable:!0,enumerable:!0,get:function(){return 403===this.status}},getHeader:{configurable:!0,enumerable:!0,writable:!0,value:function(e){return e=e.toLowerCase(),getPostman().getResponseHeader(e)||this.header[e]}},getCookie:{configurable:!0,enumerable:!0,writable:!0,value:function(e){return getPostman().getResponseCookie(e)}}});var postmanProxy={getEnvironmentVariable:function(){},setEnvironmentVariable:function(){},getGlobalVariable:function(){},setGlobalVariable:function(){},getResponseHeader:function(){},getResponseCookie:function(){}};

},{}],9:[function(require,module,exports){
"use strict";function Runnable(t,s,e){"function"==typeof s&&(e=s,s=""),this.type=t,this.isHook=!1,this.title=s,this.fn=e,this.result=null,this.error=null}var runtime=require("./runtime"),state=require("./state"),options=require("./options");module.exports=Runnable,Runnable.prototype.run=function(){state.counters[this.type]++,this.title=this.title||("it"===this.type?"test":this.type)+" #"+state.counters[this.type],state.stack.push(this);var t=state.stack.toString();options.log&&console.log("Running "+t);try{this.fn(),this.success(t)}catch(s){this.failure(s,t)}finally{state.stack.pop()}},Runnable.prototype.success=function(t){this.result=!0,"it"===this.type&&(state.results[t||this.title]=!0)},Runnable.prototype.failure=function(t,s){if(options.log&&console.error(t),options.debug,this.result=!1,this.error=t,state.results[s||this.title]=!1,state.results[t.message]=!1,runtime.requestBuilder)throw t};

},{"./options":7,"./runtime":10,"./state":11}],10:[function(require,module,exports){
(function (process,global){
"use strict";function detectNewman(){return!process.browser&&!global.process}function detectChromeApp(){return process.browser&&!getParentDocument()}function detectElectronApp(){return process.browser&&!!getParentDocument()}function detectRequestBuilder(){return detectElectronApp()&&!!window.parent.document.querySelector(".requester-builder")}function detectCollectionRunner(){return!detectRequestBuilder()}function getParentDocument(){try{return window.parent.document}catch(e){return null}}module.exports={newman:detectNewman(),chrome:detectChromeApp(),electron:detectElectronApp(),requestBuilder:detectRequestBuilder(),collectionRunner:detectCollectionRunner()};

}).call(this,require('_process'),typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"_process":53}],11:[function(require,module,exports){
"use strict";var state=module.exports={results:"object"==typeof tests?tests:{},stack:[],counters:{describe:0,it:0,before:0,after:0,beforeEach:0,afterEach:0},inAHook:function(){return this.stack.some(function(t){return t.isHook})},reset:function(){var t=this;Object.keys(this.results).length>0&&(t.results={}),Object.keys(this.counters).forEach(function(e){t.counters[e]=0})}};state.stack.toString=function(){return this.map(function(t){return t.title}).join(" ")};
 ...
 */
AssertionError.prototype.constructor=AssertionError,AssertionError.prototype.toJSON=function(r){var t=exclude("constructor","toJSON","stack"),e=t({name:this.name},this);return!1!==r&&this.stack&&(e.stack=this.stack),e};
...
e.Assertion=i,Object.defineProperty(i,"includeStack",{get:function(){return console.warn("Assertion.includeStack is deprecated, use chai.config.includeStack instead."),config.includeStack},set:function(e){console.warn("Assertion.includeStack is deprecated, use chai.config.includeStack instead."),config.includeStack=e}}),Object.defineProperty(i,"showDiff",{get:function(){return console.warn("Assertion.showDiff is deprecated, use chai.config.showDiff instead."),config.showDiff},set:function(e){console.warn("Assertion.showDiff is deprecated, use chai.config.showDiff instead."),config.showDiff=e}}),i.addProperty=function(e,i){t.addProperty(this.prototype,e,i)},i.addMethod=function(e,i){t.addMethod(this.prototype,e,i)},i.addChainableMethod=function(e,i,o){t.addChainableMethod(this.prototype,e,i,o)},i.overwriteProperty=function(e,i){t.overwriteProperty(this.prototype,e,i)},i.overwriteMethod=function(e,i){t.overwriteMethod(this.prototype,e,i)},i.overwriteChainableMethod=function(e,i,o){t.overwriteChainableMethod(this.prototype,e,i,o)},i.prototype.assert=function(e,i,s,r,c,a){var f=t.test(this,arguments);if(!0!==a&&(a=!1),!0!==config.showDiff&&(a=!1),!f){var i=t.getMessage(this,arguments),d=t.getActual(this,arguments);throw new o(i,{actual:d,expected:r,showDiff:a},config.includeStack?this.assert:n(this,"ssfi"))}},/*!
   ...
   * @api private
   */
Object.defineProperty(i.prototype,"_obj",{get:function(){return n(this,"object")},set:function(e){n(this,"object",e)}})};
...
i.ifError=function(e){if(e)throw e},i.isExtensible=function(e,n){new t(e,n).to.be.extensible},i.isNotExtensible=function(e,n){new t(e,n).to.not.be.extensible},i.isSealed=function(e,n){new t(e,n).to.be.sealed},i.isNotSealed=function(e,n){new t(e,n).to.not.be.sealed},i.isFrozen=function(e,n){new t(e,n).to.be.frozen},i.isNotFrozen=function(e,n){new t(e,n).to.not.be.frozen},/*!
   * Aliases.
   */
function a(e,n){return i[n]=i[e],a}("isOk","ok")("isNotOk","notOk")("throws","throw")("throws","Throw")("isExtensible","extensible")("isNotExtensible","notExtensible")("isSealed","sealed")("isNotSealed","notSealed")("isFrozen","frozen")("isNotFrozen","notFrozen")};
 ...
 * MIT Licensed
 */
var config=require("../config"),flag=require("./flag");module.exports=function(i,e,f){Object.defineProperty(i,e,{get:function r(){var i=flag(this,"ssfi");i&&config.includeStack===!1&&flag(this,"ssfi",r);var e=f.call(this);return void 0===e?this:e},configurable:!0})};
 ...
 * MIT Licensed
 */
var getPathInfo=require("./getPathInfo");module.exports=function(e,t){var r=getPathInfo(e,t);return r.value};
 ...
 * MIT Licensed
 */
var type=require("type-detect"),literals={number:Number,string:String};module.exports=function(e,t){var r=type(t);return"null"===r||"undefined"===r?!1:(literals[r]&&"object"!=typeof t&&(t=new literals[r](t)),e in t)};
...
function inspect(e,t,r,n){var o={showHidden:t,seen:[],stylize:function(e){return e}};return formatValue(o,e,"undefined"==typeof r?2:r)}function formatValue(e,t,r){if(t&&"function"==typeof t.inspect&&t.inspect!==exports.inspect&&(!t.constructor||t.constructor.prototype!==t)){var n=t.inspect(r);return"string"!=typeof n&&(n=formatValue(e,n,r)),n}var o=formatPrimitive(e,t);if(o)return o;if(isDOMElement(t)){if("outerHTML"in t)return t.outerHTML;try{if(document.xmlVersion){var i=new XMLSerializer;return i.serializeToString(t)}var a="http://www.w3.org/1999/xhtml",u=document.createElementNS(a,"_");return u.appendChild(t.cloneNode(!1)),html=u.innerHTML.replace("><",">"+t.innerHTML+"<"),u.innerHTML="",html}catch(l){}}var c=getEnumerableProperties(t),p=e.showHidden?getProperties(t):c;if(0===p.length||isError(t)&&(1===p.length&&"stack"===p[0]||2===p.length&&"description"===p[0]&&"stack"===p[1])){if("function"==typeof t){var s=getName(t),f=s?": "+s:"";return e.stylize("[Function"+f+"]","special")}if(isRegExp(t))return e.stylize(RegExp.prototype.toString.call(t),"regexp");if(isDate(t))return e.stylize(Date.prototype.toUTCString.call(t),"date");if(isError(t))return formatError(t)}var g="",y=!1,m=["{","}"];if(isArray(t)&&(y=!0,m=["[","]"]),"function"==typeof t){var s=getName(t),f=s?": "+s:"";g=" [Function"+f+"]"}if(isRegExp(t)&&(g=" "+RegExp.prototype.toString.call(t)),isDate(t)&&(g=" "+Date.prototype.toUTCString.call(t)),isError(t))return formatError(t);if(0===p.length&&(!y||0==t.length))return m[0]+g+m[1];if(0>r)return isRegExp(t)?e.stylize(RegExp.prototype.toString.call(t),"regexp"):e.stylize("[Object]","special");e.seen.push(t);var d;return d=y?formatArray(e,t,r,c,p):p.map(function(n){return formatProperty(e,t,r,c,n,y)}),e.seen.pop(),reduceToSingleString(d,g,m)}function formatPrimitive(e,t){switch(typeof t){case"undefined":return e.stylize("undefined","undefined");case"string":var r="'"+JSON.stringify(t).replace(/^"|"$/g,"").replace(/'/g,"\\'").replace(/\\"/g,'"')+"'";return e.stylize(r,"string");case"number":return 0===t&&1/t===-(1/0)?e.stylize("-0","number"):e.stylize(""+t,"number");case"boolean":return e.stylize(""+t,"boolean")}return null===t?e.stylize("null","null"):void 0}function formatError(e){return"["+Error.prototype.toString.call(e)+"]"}function formatArray(e,t,r,n,o){for(var i=[],a=0,u=t.length;u>a;++a)Object.prototype.hasOwnProperty.call(t,String(a))?i.push(formatProperty(e,t,r,n,String(a),!0)):i.push("");return o.forEach(function(o){o.match(/^\d+$/)||i.push(formatProperty(e,t,r,n,o,!0))}),i}function formatProperty(e,t,r,n,o,i){var a,u;if(t.__lookupGetter__&&(t.__lookupGetter__(o)?u=t.__lookupSetter__(o)?e.stylize("[Getter/Setter]","special"):e.stylize("[Getter]","special"):t.__lookupSetter__(o)&&(u=e.stylize("[Setter]","special"))),n.indexOf(o)<0&&(a="["+o+"]"),u||(e.seen.indexOf(t[o])<0?(u=null===r?formatValue(e,t[o],null):formatValue(e,t[o],r-1),u.indexOf("\n")>-1&&(u=i?u.split("\n").map(function(e){return"  "+e}).join("\n").substr(2):"\n"+u.split("\n").map(function(e){return"   "+e}).join("\n"))):u=e.stylize("[Circular]","special")),"undefined"==typeof a){if(i&&o.match(/^\d+$/))return u;a=JSON.stringify(""+o),a.match(/^"([a-zA-Z_][a-zA-Z_0-9]*)"$/)?(a=a.substr(1,a.length-2),a=e.stylize(a,"name")):(a=a.replace(/'/g,"\\'").replace(/\\"/g,'"').replace(/(^"|"$)/g,"'"),a=e.stylize(a,"string"))}return a+": "+u}function reduceToSingleString(e,t,r){var n=0,o=e.reduce(function(e,t){return n++,t.indexOf("\n")>=0&&n++,e+t.length+1},0);return o>60?r[0]+(""===t?"":t+"\n ")+" "+e.join(",\n  ")+" "+r[1]:r[0]+t+" "+e.join(", ")+" "+r[1]}function isArray(e){return Array.isArray(e)||"object"==typeof e&&"[object Array]"===objectToString(e)}function isRegExp(e){return"object"==typeof e&&"[object RegExp]"===objectToString(e)}function isDate(e){return"object"==typeof e&&"[object Date]"===objectToString(e)}function isError(e){return"object"==typeof e&&"[object Error]"===objectToString(e)}function objectToString(e){return Object.prototype.toString.call(e)}var getName=require("./getName"),getProperties=require("./getProperties"),getEnumerableProperties=require("./getEnumerableProperties");module.exports=inspect;var isDOMElement=function(e){return"object"==typeof HTMLElement?e instanceof HTMLElement:e&&"object"==typeof e&&1===e.nodeType&&"string"==typeof e.nodeName};
 ...
 * Module dependencies
 */
function deepEqual(e,r,t){return sameValue(e,r)?!0:"date"===type(e)?dateEqual(e,r):"regexp"===type(e)?regexpEqual(e,r):Buffer.isBuffer(e)?bufferEqual(e,r):"arguments"===type(e)?argumentsEqual(e,r,t):typeEqual(e,r)?"object"!==type(e)&&"object"!==type(r)&&"array"!==type(e)&&"array"!==type(r)?sameValue(e,r):objectEqual(e,r,t):!1}/*!
 ...
 * @return {Boolean} result
 */
function dateEqual(e,r){return"date"!==type(r)?!1:sameValue(e.getTime(),r.getTime())}/*!
 ...
 * @return {Boolean} result
 */
function regexpEqual(e,r){return"regexp"!==type(r)?!1:sameValue(e.toString(),r.toString())}/*!
 ...
 * @return {Boolean} result
 */
function argumentsEqual(e,r,t){return"arguments"!==type(r)?!1:(e=[].slice.call(e),r=[].slice.call(r),deepEqual(e,r,t))}/*!
 ...
 * @return {Boolean} result
 */
function bufferEqual(e,r){return Buffer.isBuffer(r)?iterableEqual(e,r):!1}/*!
...
"use strict";var Utils=require("./utils"),internals={delimiter:"&",arrayPrefixGenerators:{brackets:function(e){return e+"[]"},indices:function(e,r){return e+"["+r+"]"},repeat:function(e){return e}},strictNullHandling:!1,skipNulls:!1,encode:!0};internals.stringify=function(e,r,n,t,i,l,a,s){var o=e;if("function"==typeof a)o=a(r,o);else if(Utils.isBuffer(o))o=String(o);else if(o instanceof Date)o=o.toISOString();else if(null===o){if(t)return l?Utils.encode(r):r;o=""}if("string"==typeof o||"number"==typeof o||"boolean"==typeof o)return l?[Utils.encode(r)+"="+Utils.encode(o)]:[r+"="+o];var f=[];if("undefined"==typeof o)return f;var u;if(Array.isArray(a))u=a;else{var c=Object.keys(o);u=s?c.sort(s):c}for(var y=0;y<u.length;++y){var d=u[y];i&&null===o[d]||(f=Array.isArray(o)?f.concat(internals.stringify(o[d],n(r,d),n,t,i,l,a)):f.concat(internals.stringify(o[d],r+"["+d+"]",n,t,i,l,a)))}return f},module.exports=function(e,r){var n,t,i=e,l=r||{},a="undefined"==typeof l.delimiter?internals.delimiter:l.delimiter,s="boolean"==typeof l.strictNullHandling?l.strictNullHandling:internals.strictNullHandling,o="boolean"==typeof l.skipNulls?l.skipNulls:internals.skipNulls,f="boolean"==typeof l.encode?l.encode:internals.encode,u="function"==typeof l.sort?l.sort:null;"function"==typeof l.filter?(t=l.filter,i=t("",i)):Array.isArray(l.filter)&&(n=t=l.filter);var c=[];if("object"!=typeof i||null===i)return"";var y;y=l.arrayFormat in internals.arrayPrefixGenerators?l.arrayFormat:"indices"in l?l.indices?"indices":"repeat":"indices";var d=internals.arrayPrefixGenerators[y];n||(n=Object.keys(i)),u&&n.sort(u);for(var p=0;p<n.length;++p){var g=n[p];o&&null===i[g]||(c=c.concat(internals.stringify(i[g],g,d,s,o,f,t,u)))}return c.join(a)};
...
},{"./lib/type":63}],63:[function(require,module,exports){
/*!
 * type-detect
 * Copyright(c) 2013 jake luer <jake@alogicalparadox.com>
 * MIT Licensed
