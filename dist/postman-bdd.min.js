...
"use strict";var isIP=require("is-ip"),qs=require("qs"),url=require("url"),Cookie=require("cookiejar");module.exports=function(e,t){function o(e,t){return t&&(t=t.toLowerCase()),e.headers?e.headers[t]:e.getHeader?e.getHeader(t):void 0}function s(e,t){if(e.getCookie)return e.getCookie(t);var s=o(e,"set-cookie");s||(s=(o(e,"cookie")||"").split(";"));var i=Cookie.CookieJar();return i.setCookies(s),i.getCookie(t,new Cookie.CookieAccessInfo)}function i(e){var s=a[e];r.addProperty(e,function(){new r(this._obj).to.have.headers;var e=o(this._obj,"content-type"),i="undefined"===t.inspect(e)?"headers":t.inspect(e);this.assert(e&&e.indexOf(s)>=0,"expected "+i+" to include '"+s+"'","expected "+i+" to not include '"+s+"'")})}var r=e.Assertion,a={json:"application/json",text:"text/plain",html:"text/html"};r.addMethod("status",function(e){new r(this._obj).to.have.property("status");var t=this._obj.status;this.assert(t===e,"expected #{this} to have status code #{exp} but got #{act}","expected #{this} to not have status code #{act}",e,t)}),r.addMethod("header",function(e,s){var i=o(this._obj,e);arguments.length<2?this.assert("undefined"!=typeof i||null===i,"expected header '"+e+"' to exist","expected header '"+e+"' to not exist"):s instanceof RegExp?this.assert(s.test(i),"expected header '"+e+"' to match "+s+" but got "+t.inspect(i),"expected header '"+e+"' not to match "+s+" but got "+t.inspect(i),s,i):this.assert(i===s,"expected header '"+e+"' to have value "+s+" but got "+t.inspect(i),"expected header '"+e+"' to not have value "+s,s,i)}),r.addProperty("headers",function(){this.assert("function"==typeof this._obj.getHeader||Object.keys(this._obj.headers||{}).length>0,"expected #{this} to have headers or getHeader method","expected #{this} to not have headers or getHeader method")}),r.addProperty("ip",function(){this.assert(isIP(this._obj),"expected #{this} to be an ip","expected #{this} to not be an ip")}),Object.keys(a).forEach(i),r.addProperty("redirect",function(){var e=[301,302,303],t=this._obj.status,o=this._obj.redirects;this.assert(e.indexOf(t)>=0||o&&o.length,"expected redirect with 30{1-3} status code but got "+t,"expected not to redirect but got "+t+" status")}),r.addMethod("redirectTo",function(e){var o=this._obj.redirects;if(new r(this._obj).to.redirect,o&&o.length)this.assert(o.indexOf(e)>-1,"expected redirect to "+e+" but got "+o.join(" then "),"expected not to redirect to "+e+" but got "+o.join(" then "));else{var s=new r(this._obj);t.transferFlags(this,s),s["with"].header("location",e)}}),r.addMethod("param",function(e,o){var s=new r;t.transferFlags(this,s),s._obj=qs.parse(url.parse(this._obj.url).query),s.property.apply(s,arguments)}),r.addMethod("cookie",function(e,t){var o=s(this._obj,e);2===arguments.length?this.assert(o.value===t,"expected cookie '"+e+"' to have value #{exp} but got #{act}","expected cookie '"+e+"' to not have value #{exp}",t,o.value):this.assert("undefined"!=typeof o||null===o,"expected cookie '"+e+"' to exist","expected cookie '"+e+"' to not exist")}),e.Assertion.addMethod("schema",function(e){var t=tv4.validate(this._obj,e);if(!t)throw tv4.error})};
