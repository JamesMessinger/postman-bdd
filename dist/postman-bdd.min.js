...
var Runnable=require("./runnable"),Hook=require("./hook"),state=require("./state"),hooks={};_._postmanBDD=_._postmanBDD||{},["before","after","beforeEach","afterEach"].forEach(function(e){var n=hooks[e]=new Hook(e);_._postmanBDD[e]=n.push.bind(n),_._postmanBDD[e].pop=n.pop.bind(n),_._postmanBDD[e].clear=n.clear.bind(n),_._postmanBDD[e].count=n.count.bind(n)}),_._postmanBDD.describe=function(e,n){0===state.stack.length&&(state.reset(),hooks.before.run());var t=new Runnable("describe",e,n);return t.run(),0===state.stack.length&&hooks.after.run(),state.results},_._postmanBDD.it=function(e,n){hooks.beforeEach.run();var t=new Runnable("it",e,n);return t.run(),hooks.afterEach.run(),t.result};
...
require("./_prelude"),require("./bdd"),module.exports=require("./options"),_._postmanBDD.response=require("./response"),_._postmanBDD.chai=require("chai"),_._postmanBDD.chai.should(),_._postmanBDD.assert=_._postmanBDD.chai.assert,_._postmanBDD.expect=_._postmanBDD.chai.expect;var assertions=require("./assertions");_._postmanBDD.chai.use(assertions);
