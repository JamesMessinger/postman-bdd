...
var Runnable=require("./runnable"),Hook=require("./hook"),state=require("./state"),hooks={};Object._postmanBDD=Object._postmanBDD||{},["before","after","beforeEach","afterEach"].forEach(function(e){var t=hooks[e]=new Hook(e);Object._postmanBDD[e]=t.push.bind(t),Object._postmanBDD[e].pop=t.pop.bind(t),Object._postmanBDD[e].clear=t.clear.bind(t),Object._postmanBDD[e].count=t.count.bind(t)}),Object._postmanBDD.describe=function(e,t){0===state.stack.length&&(state.reset(),hooks.before.run());var n=new Runnable("describe",e,t);return n.run(),0===state.stack.length&&hooks.after.run(),state.results},Object._postmanBDD.it=function(e,t){hooks.beforeEach.run();var n=new Runnable("it",e,t);return n.run(),hooks.afterEach.run(),n.result};
...
require("./_prelude"),require("./bdd"),module.exports=require("./options"),Object._postmanBDD.response=require("./response"),Object._postmanBDD.chai=require("chai"),Object._postmanBDD.chai.should(),Object._postmanBDD.assert=Object._postmanBDD.chai.assert,Object._postmanBDD.expect=Object._postmanBDD.chai.expect;var assertions=require("./assertions");Object._postmanBDD.chai.use(assertions);
...
},{"./lib/type":62}],62:[function(require,module,exports){
/*!
 * type-detect
 * Copyright(c) 2013 jake luer <jake@alogicalparadox.com>
 * MIT Licensed
