...
(function (global){
"use strict";require("./_prelude"),require("./bdd"),module.exports=require("./options"),global.response=require("./response"),global.chai=require("chai"),global.chai.should(),global.assert=chai.assert,global.expect=chai.expect;var assertions=require("./assertions");chai.use(assertions);
