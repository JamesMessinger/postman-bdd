...
i.ifError=function(e){if(e)throw e},i.isExtensible=function(e,n){new t(e,n).to.be.extensible},i.isNotExtensible=function(e,n){new t(e,n).to.not.be.extensible},i.isSealed=function(e,n){new t(e,n).to.be.sealed},i.isNotSealed=function(e,n){new t(e,n).to.not.be.sealed},i.isFrozen=function(e,n){new t(e,n).to.be.frozen},i.isNotFrozen=function(e,n){new t(e,n).to.not.be.frozen},/*!
   * Aliases.
   */
function e(n,t){return i[t]=i[n],e}("isOk","ok")("isNotOk","notOk")("throws","throw")("throws","Throw")("isExtensible","extensible")("isNotExtensible","notExtensible")("isSealed","sealed")("isNotSealed","notSealed")("isFrozen","frozen")("isNotFrozen","notFrozen")};
 ...
 * Module dependencies
 */
var transferFlags=require("./transferFlags"),flag=require("./flag"),config=require("../config"),hasProtoSupport="__proto__"in Object,excludeNames=/^(?:length|name|arguments|caller)$/,call=Function.prototype.call,apply=Function.prototype.apply;module.exports=function(e,t,r,a){"function"!=typeof a&&(a=function(){});var o={method:r,chainingBehavior:a};e.__methods||(e.__methods={}),e.__methods[t]=o,Object.defineProperty(e,t,{get:function(){o.chainingBehavior.call(this);var t=function e(){var t=flag(this,"ssfi");t&&config.includeStack===!1&&flag(this,"ssfi",e);var r=o.method.apply(this,arguments);return void 0===r?this:r};if(hasProtoSupport){var r=t.__proto__=Object.create(this);r.call=call,r.apply=apply}else{var a=Object.getOwnPropertyNames(e);a.forEach(function(r){if(!excludeNames.test(r)){var a=Object.getOwnPropertyDescriptor(e,r);Object.defineProperty(t,r,a)}})}return transferFlags(this,t),t},configurable:!0})};
 ...
 * MIT Licensed
 */
var config=require("../config"),flag=require("./flag");module.exports=function(i,e,f){Object.defineProperty(i,e,{get:function i(){var e=flag(this,"ssfi");e&&config.includeStack===!1&&flag(this,"ssfi",i);var r=f.call(this);return void 0===r?this:r},configurable:!0})};
 ...
 * MIT Licensed
 */
module.exports=function(e,l,t){var n=e.__flags||(e.__flags=Object.create(null));return 3!==arguments.length?n[l]:void(n[l]=t)};
 ...
 * MIT Licensed
 */
module.exports=function(e){function t(e){o.indexOf(e)===-1&&o.push(e)}for(var o=Object.getOwnPropertyNames(e),r=Object.getPrototypeOf(e);null!==r;)Object.getOwnPropertyNames(r).forEach(t),r=Object.getPrototypeOf(r);return o};
 ...
 */
AssertionError.prototype.constructor=AssertionError,AssertionError.prototype.toJSON=function(r){var t=exclude("constructor","toJSON","stack"),o=t({name:this.name},this);return!1!==r&&this.stack&&(o.stack=this.stack),o};
