...
(function (global){
"use strict";require("./_prelude"),require("./bdd"),module.exports=require("./options");var chai=require("chai");chai.should(),global.assert=chai.assert,global.expect=chai.expect;var assertions=require("./assertions");chai.use(assertions);
