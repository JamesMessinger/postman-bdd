...
require("./_prelude"),require("./bdd"),module.exports=require("./options"),response=require("./response"),chai=require("chai"),chai.should(),assert=chai.assert,expect=chai.expect;var assertions=require("./assertions");chai.use(assertions);
