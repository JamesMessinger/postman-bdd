...
"use strict";function Runnable(t,e,s){"function"==typeof e&&(s=e,e=""),this.type=t,this.isHook=!1,this.title=e,this.fn=s,this.result=null,this.error=null}var runtime=require("./runtime"),state=require("./state"),options=require("./options");module.exports=Runnable,Runnable.prototype.run=function(){state.counters[this.type]++,this.title=this.title||("it"===this.type?"test":this.type)+" #"+state.counters[this.type],state.stack.push(this);var t=state.stack.toString();options.log&&console.log("Running "+t);try{this.fn(),this.success(t)}catch(e){this.failure(e,t)}finally{state.stack.pop()}},Runnable.prototype.success=function(t){this.result=!0,"it"===this.type&&(state.results[t||this.title]=!0)},Runnable.prototype.failure=function(t,e){if(options.log&&("function"==typeof console.error?console.error(t):console.log(t)),options.debug,this.result=!1,this.error=t,state.results[e||this.title]=!1,state.results[t.message]=!1,runtime.requestBuilder)throw t};

},{"./options":6,"./runtime":9,"./state":10}],9:[function(require,module,exports){
(function (process,global){
"use strict";function detectNewman(){return!process.browser&&!global.process}function detectChromeApp(){return process.browser&&!getParentDocument()}function detectElectronApp(){return process.browser&&!!getParentDocument()}function detectRequestBuilder(){return detectElectronApp()&&!!window.parent.document.querySelector(".requester-builder")}function detectCollectionRunner(){return!detectRequestBuilder()}function getParentDocument(){try{return window.parent.document}catch(e){return null}}module.exports={global:detectNewman()?this:global,newman:detectNewman(),chrome:detectChromeApp(),electron:detectElectronApp(),requestBuilder:detectRequestBuilder(),collectionRunner:detectCollectionRunner()};
