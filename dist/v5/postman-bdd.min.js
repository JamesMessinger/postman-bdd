 ...
 * MIT Licensed
 */
module.exports=function(e,t){function s(e,s){s&&S(this,"message",s),e=e.toLowerCase();var o=S(this,"object"),a=~["a","e","i","o","u"].indexOf(e.charAt(0))?"an ":"a ";this.assert(e===t.type(o).toLowerCase(),"expected #{this} to be "+a+e,"expected #{this} not to be "+a+e)}function o(e,s){return t.isNaN(e)&&t.isNaN(s)||e===s}function a(){S(this,"contains",!0)}function i(e,s){s&&S(this,"message",s);var a=S(this,"object"),i=t.type(a).toLowerCase(),r=S(this,"message"),n=S(this,"negate"),h=S(this,"ssfi"),d=S(this,"deep"),c=d?"deep ":"";r=r?r+": ":"";var p=!1;switch(i){case"string":p=-1!==a.indexOf(e);break;case"weakset":if(d)throw new D(r+"unable to use .deep.include with WeakSet",void 0,h);p=a.has(e);break;case"map":var l=d?t.eql:o;a.forEach(function(t){p=p||l(t,e)});break;case"set":d?a.forEach(function(s){p=p||t.eql(s,e)}):p=a.has(e);break;case"array":p=d?a.some(function(s){return t.eql(s,e)}):-1!==a.indexOf(e);break;default:if(e!==Object(e))throw new D(r+"object tested must be an array, a map, an object, a set, a string, or a weakset, but "+i+" given",void 0,h);var u=Object.keys(e),b=null,f=0;if(u.forEach(function(s){var o=new N(a);if(t.transferFlags(this,o,!0),S(o,"lockSsfi",!0),!n||1===u.length)return void o.property(s,e[s]);try{o.property(s,e[s])}catch(e){if(!t.checkError.compatibleConstructor(e,D))throw e;null===b&&(b=e),f++}},this),n&&u.length>1&&f===u.length)throw b;return}this.assert(p,"expected #{this} to "+c+"include "+t.inspect(e),"expected #{this} to not "+c+"include "+t.inspect(e))}function r(){var e=S(this,"object"),s=t.type(e);this.assert("Arguments"===s,"expected #{this} to be arguments but got "+s,"expected #{this} to not be arguments")}function n(e,t){t&&S(this,"message",t);var s=S(this,"object");if(S(this,"deep"))return this.eql(e);this.assert(e===s,"expected #{this} to equal #{exp}","expected #{this} to not equal #{exp}",e,this._obj,!0)}function h(e,s){s&&S(this,"message",s),this.assert(t.eql(e,S(this,"object")),"expected #{this} to deeply equal #{exp}","expected #{this} to not deeply equal #{exp}",e,this._obj,!0)}function d(e,s){s&&S(this,"message",s);var o=S(this,"object"),a=S(this,"doLength"),i=S(this,"message"),r=i?i+": ":"",n=S(this,"ssfi"),h=t.type(o).toLowerCase(),d=t.type(e).toLowerCase(),c=!0;if(a&&new N(o,i,n,!0).to.have.property("length"),a||"date"!==h||"date"===d)if("number"===d||!a&&"number"!==h)if(a||"date"===h||"number"===h)c=!1;else{var p="string"===h?"'"+o+"'":o;errorMessage=r+"expected "+p+" to be a number or a date"}else errorMessage=r+"the argument to above must be a number";else errorMessage=r+"the argument to above must be a date";if(c)throw new D(errorMessage,void 0,n);if(a){var l=o.length;this.assert(l>e,"expected #{this} to have a length above #{exp} but got #{act}","expected #{this} to not have a length above #{exp}",e,l)}else this.assert(o>e,"expected #{this} to be above #{exp}","expected #{this} to be at most #{exp}",e)}function c(e,s){s&&S(this,"message",s);var o=S(this,"object"),a=S(this,"doLength"),i=S(this,"message"),r=i?i+": ":"",n=S(this,"ssfi"),h=t.type(o).toLowerCase(),d=t.type(e).toLowerCase(),c=!0;if(a&&new N(o,i,n,!0).to.have.property("length"),a||"date"!==h||"date"===d)if("number"===d||!a&&"number"!==h)if(a||"date"===h||"number"===h)c=!1;else{var p="string"===h?"'"+o+"'":o;errorMessage=r+"expected "+p+" to be a number or a date"}else errorMessage=r+"the argument to least must be a number";else errorMessage=r+"the argument to least must be a date";if(c)throw new D(errorMessage,void 0,n);if(a){var l=o.length;this.assert(l>=e,"expected #{this} to have a length at least #{exp} but got #{act}","expected #{this} to have a length below #{exp}",e,l)}else this.assert(o>=e,"expected #{this} to be at least #{exp}","expected #{this} to be below #{exp}",e)}function p(e,s){s&&S(this,"message",s);var o=S(this,"object"),a=S(this,"doLength"),i=S(this,"message"),r=i?i+": ":"",n=S(this,"ssfi"),h=t.type(o).toLowerCase(),d=t.type(e).toLowerCase(),c=!0;if(a&&new N(o,i,n,!0).to.have.property("length"),a||"date"!==h||"date"===d)if("number"===d||!a&&"number"!==h)if(a||"date"===h||"number"===h)c=!1;else{var p="string"===h?"'"+o+"'":o;errorMessage=r+"expected "+p+" to be a number or a date"}else errorMessage=r+"the argument to below must be a number";else errorMessage=r+"the argument to below must be a date";if(c)throw new D(errorMessage,void 0,n);if(a){var l=o.length;this.assert(l<e,"expected #{this} to have a length below #{exp} but got #{act}","expected #{this} to not have a length below #{exp}",e,l)}else this.assert(o<e,"expected #{this} to be below #{exp}","expected #{this} to be at least #{exp}",e)}function l(e,s){s&&S(this,"message",s);var o=S(this,"object"),a=S(this,"doLength"),i=S(this,"message"),r=i?i+": ":"",n=S(this,"ssfi"),h=t.type(o).toLowerCase(),d=t.type(e).toLowerCase(),c=!0;if(a&&new N(o,i,n,!0).to.have.property("length"),a||"date"!==h||"date"===d)if("number"===d||!a&&"number"!==h)if(a||"date"===h||"number"===h)c=!1;else{var p="string"===h?"'"+o+"'":o;errorMessage=r+"expected "+p+" to be a number or a date"}else errorMessage=r+"the argument to most must be a number";else errorMessage=r+"the argument to most must be a date";if(c)throw new D(errorMessage,void 0,n);if(a){var l=o.length;this.assert(l<=e,"expected #{this} to have a length at most #{exp} but got #{act}","expected #{this} to have a length above #{exp}",e,l)}else this.assert(o<=e,"expected #{this} to be at most #{exp}","expected #{this} to be above #{exp}",e)}function u(e,s){s&&S(this,"message",s);var o=S(this,"object"),a=S(this,"ssfi"),i=S(this,"message");try{var r=o instanceof e}catch(s){if(s instanceof TypeError)throw i=i?i+": ":"",new D(i+"The instanceof assertion needs a constructor but "+t.type(e)+" was given.",void 0,a);throw s}var n=t.getName(e);null===n&&(n="an unnamed constructor"),this.assert(r,"expected #{this} to be an instance of "+n,"expected #{this} to not be an instance of "+n)}function b(e,s,o){o&&S(this,"message",o);var a=S(this,"nested"),i=S(this,"own"),r=S(this,"message"),n=S(this,"object"),h=S(this,"ssfi");if(a&&i)throw r=r?r+": ":"",new D(r+'The "nested" and "own" flags cannot be combined.',void 0,h);if(null===n||void 0===n)throw r=r?r+": ":"",new D(r+"Target cannot be null or undefined.",void 0,h);var d=S(this,"deep"),c=S(this,"negate"),p=a?t.getPathInfo(n,e):null,l=a?p.value:n[e],u="";d&&(u+="deep "),i&&(u+="own "),a&&(u+="nested "),u+="property ";var b;b=i?Object.prototype.hasOwnProperty.call(n,e):a?p.exists:t.hasProperty(n,e),c&&1!==arguments.length||this.assert(b,"expected #{this} to have "+u+t.inspect(e),"expected #{this} to not have "+u+t.inspect(e)),arguments.length>1&&this.assert(b&&(d?t.eql(s,l):s===l),"expected #{this} to have "+u+t.inspect(e)+" of #{exp}, but got #{act}","expected #{this} to not have "+u+t.inspect(e)+" of #{act}",s,l),S(this,"object",l)}function f(e,t,s){S(this,"own",!0),b.apply(this,arguments)}function g(e,s,o){"string"==typeof s&&(o=s,s=null),o&&S(this,"message",o);var a=S(this,"object"),i=Object.getOwnPropertyDescriptor(Object(a),e);i&&s?this.assert(t.eql(s,i),"expected the own property descriptor for "+t.inspect(e)+" on #{this} to match "+t.inspect(s)+", got "+t.inspect(i),"expected the own property descriptor for "+t.inspect(e)+" on #{this} to not match "+t.inspect(s),s,i,!0):this.assert(i,"expected #{this} to have an own property descriptor for "+t.inspect(e),"expected #{this} to not have an own property descriptor for "+t.inspect(e)),S(this,"object",i)}function m(){S(this,"doLength",!0)}function x(e,t){t&&S(this,"message",t);var s=S(this,"object"),o=S(this,"message"),a=S(this,"ssfi");new N(s,o,a,!0).to.have.property("length");var i=s.length;this.assert(i==e,"expected #{this} to have a length of #{exp} but got #{act}","expected #{this} to not have a length of #{act}",e,i)}function v(e,t){t&&S(this,"message",t);var s=S(this,"object");this.assert(e.exec(s),"expected #{this} to match "+e,"expected #{this} not to match "+e)}function w(e){var s,o=S(this,"object"),a=t.type(o),i=t.type(e),r=S(this,"ssfi"),n=S(this,"deep"),h="",d=!0,c=S(this,"message");c=c?c+": ":"";var p=c+"when testing keys against an object or an array you must give a single Array|Object|String argument or multiple String arguments";if("Map"===a||"Set"===a)h=n?"deeply ":"",l=[],o.forEach(function(e,t){l.push(t)}),"Array"!==i&&(e=Array.prototype.slice.call(arguments));else{switch(l=t.getOwnEnumerableProperties(o),i){case"Array":if(arguments.length>1)throw new D(p,void 0,r);break;case"Object":if(arguments.length>1)throw new D(p,void 0,r);e=Object.keys(e);break;default:e=Array.prototype.slice.call(arguments)}e=e.map(function(e){return"symbol"==typeof e?e:String(e)})}if(!e.length)throw new D(c+"keys required",void 0,r);var l,u=e.length,b=S(this,"any"),f=S(this,"all"),g=e;if(b||f||(f=!0),b&&(d=g.some(function(e){return l.some(function(s){return n?t.eql(e,s):e===s})})),f&&(d=g.every(function(e){return l.some(function(s){return n?t.eql(e,s):e===s})}),S(this,"contains")||(d=d&&e.length==l.length)),u>1){e=e.map(function(e){return t.inspect(e)});var m=e.pop();f&&(s=e.join(", ")+", and "+m),b&&(s=e.join(", ")+", or "+m)}else s=t.inspect(e[0]);s=(u>1?"keys ":"key ")+s,s=(S(this,"contains")?"contain ":"have ")+s,this.assert(d,"expected #{this} to "+h+s,"expected #{this} to not "+h+s,g.slice(0).sort(t.compareByInspect),l.sort(t.compareByInspect),!0)}function y(e,s,o){o&&S(this,"message",o);var a=S(this,"object"),i=S(this,"ssfi"),r=S(this,"message"),n=S(this,"negate")||!1;new N(a,r,i,!0).is.a("function"),(e instanceof RegExp||"string"==typeof e)&&(s=e,e=null);var h;try{a()}catch(e){h=e}var d=void 0===e&&void 0===s,c=Boolean(e&&s),p=!1,l=!1;if(d||!d&&!n){var u="an error";e instanceof Error?u="#{exp}":e&&(u=t.checkError.getConstructorName(e)),this.assert(h,"expected #{this} to throw "+u,"expected #{this} to not throw an error but #{act} was thrown",e&&e.toString(),h instanceof Error?h.toString():"string"==typeof h?h:h&&t.checkError.getConstructorName(h))}if(e&&h){if(e instanceof Error){t.checkError.compatibleInstance(h,e)===n&&(c&&n?p=!0:this.assert(n,"expected #{this} to throw #{exp} but #{act} was thrown","expected #{this} to not throw #{exp}"+(h&&!n?" but #{act} was thrown":""),e.toString(),h.toString()))}t.checkError.compatibleConstructor(h,e)===n&&(c&&n?p=!0:this.assert(n,"expected #{this} to throw #{exp} but #{act} was thrown","expected #{this} to not throw #{exp}"+(h?" but #{act} was thrown":""),e instanceof Error?e.toString():e&&t.checkError.getConstructorName(e),h instanceof Error?h.toString():h&&t.checkError.getConstructorName(h)))}if(h&&void 0!==s&&null!==s){var b="including";s instanceof RegExp&&(b="matching");t.checkError.compatibleMessage(h,s)===n&&(c&&n?l=!0:this.assert(n,"expected #{this} to throw error "+b+" #{exp} but got #{act}","expected #{this} to throw error not "+b+" #{exp}",s,t.checkError.getMessage(h)))}p&&l&&this.assert(n,"expected #{this} to throw #{exp} but #{act} was thrown","expected #{this} to not throw #{exp}"+(h?" but #{act} was thrown":""),e instanceof Error?e.toString():e&&t.checkError.getConstructorName(e),h instanceof Error?h.toString():h&&t.checkError.getConstructorName(h)),S(this,"object",h)}function M(e,s){s&&S(this,"message",s);var o=S(this,"object"),a=S(this,"itself"),i="function"!=typeof o||a?o[e]:o.prototype[e];this.assert("function"==typeof i,"expected #{this} to respond to "+t.inspect(e),"expected #{this} to not respond to "+t.inspect(e))}function j(e,s){s&&S(this,"message",s);var o=S(this,"object"),a=e(o);this.assert(a,"expected #{this} to satisfy "+t.objDisplay(e),"expected #{this} to not satisfy"+t.objDisplay(e),!S(this,"negate"),a)}function k(e,t,s){s&&S(this,"message",s);var o=S(this,"object"),a=S(this,"message"),i=S(this,"ssfi");if(new N(o,a,i,!0).is.a("number"),"number"!=typeof e||"number"!=typeof t)throw a=a?a+": ":"",new D(a+"the arguments to closeTo or approximately must be numbers",void 0,i);this.assert(Math.abs(o-e)<=t,"expected #{this} to be close to "+e+" +/- "+t,"expected #{this} not to be close to "+e+" +/- "+t)}function O(e,t,s,o,a){if(!o){if(e.length!==t.length)return!1;t=t.slice()}return e.every(function(e,i){if(a)return s?s(e,t[i]):e===t[i];if(!s){var r=t.indexOf(e);return-1!==r&&(o||t.splice(r,1),!0)}return t.some(function(a,i){return!!s(e,a)&&(o||t.splice(i,1),!0)})})}function C(e,t){t&&S(this,"message",t);var s=S(this,"object"),o=S(this,"message"),a=S(this,"ssfi");new N(e,o,a,!0).to.be.an("array"),this.assert(e.indexOf(s)>-1,"expected #{this} to be one of #{exp}","expected #{this} to not be one of #{exp}",e,s)}function P(e,t,s){s&&S(this,"message",s);var o=S(this,"object"),a=S(this,"message"),i=S(this,"ssfi");new N(o,a,i,!0).is.a("function");var r;t?(new N(e,a,i,!0).to.have.property(t),r=e[t]):(new N(e,a,i,!0).is.a("function"),r=e()),o();var n=void 0===t||null===t?e():e[t],h=void 0===t||null===t?r:"."+t;S(this,"deltaMsgObj",h),S(this,"initialDeltaValue",r),S(this,"finalDeltaValue",n),S(this,"deltaBehavior","change"),S(this,"realDelta",n!==r),this.assert(r!==n,"expected "+h+" to change","expected "+h+" to not change")}function E(e,t,s){s&&S(this,"message",s);var o=S(this,"object"),a=S(this,"message"),i=S(this,"ssfi");new N(o,a,i,!0).is.a("function");var r;t?(new N(e,a,i,!0).to.have.property(t),r=e[t]):(new N(e,a,i,!0).is.a("function"),r=e()),new N(r,a,i,!0).is.a("number"),o();var n=void 0===t||null===t?e():e[t],h=void 0===t||null===t?r:"."+t;S(this,"deltaMsgObj",h),S(this,"initialDeltaValue",r),S(this,"finalDeltaValue",n),S(this,"deltaBehavior","increase"),S(this,"realDelta",n-r),this.assert(n-r>0,"expected "+h+" to increase","expected "+h+" to not increase")}function L(e,t,s){s&&S(this,"message",s);var o=S(this,"object"),a=S(this,"message"),i=S(this,"ssfi");new N(o,a,i,!0).is.a("function");var r;t?(new N(e,a,i,!0).to.have.property(t),r=e[t]):(new N(e,a,i,!0).is.a("function"),r=e()),new N(r,a,i,!0).is.a("number"),o();var n=void 0===t||null===t?e():e[t],h=void 0===t||null===t?r:"."+t;S(this,"deltaMsgObj",h),S(this,"initialDeltaValue",r),S(this,"finalDeltaValue",n),S(this,"deltaBehavior","decrease"),S(this,"realDelta",r-n),this.assert(n-r<0,"expected "+h+" to decrease","expected "+h+" to not decrease")}function q(e,t){t&&S(this,"message",t);var s,o=S(this,"deltaMsgObj"),a=S(this,"initialDeltaValue"),i=S(this,"finalDeltaValue"),r=S(this,"deltaBehavior"),n=S(this,"realDelta");s="change"===r?Math.abs(i-a)===Math.abs(e):n===Math.abs(e),this.assert(s,"expected "+o+" to "+r+" by "+e,"expected "+o+" to not "+r+" by "+e)}var N=e.Assertion,D=e.AssertionError,S=t.flag;["to","be","been","is","and","has","have","with","that","which","at","of","same","but","does"].forEach(function(e){N.addProperty(e)}),N.addProperty("not",function(){S(this,"negate",!0)}),N.addProperty("deep",function(){S(this,"deep",!0)}),N.addProperty("nested",function(){S(this,"nested",!0)}),N.addProperty("own",function(){S(this,"own",!0)}),N.addProperty("ordered",function(){S(this,"ordered",!0)}),N.addProperty("any",function(){S(this,"any",!0),S(this,"all",!1)}),N.addProperty("all",function(){S(this,"all",!0),S(this,"any",!1)}),N.addChainableMethod("an",s),N.addChainableMethod("a",s),N.addChainableMethod("include",i,a),N.addChainableMethod("contain",i,a),N.addChainableMethod("contains",i,a),N.addChainableMethod("includes",i,a),N.addProperty("ok",function(){this.assert(S(this,"object"),"expected #{this} to be truthy","expected #{this} to be falsy")}),N.addProperty("true",function(){this.assert(!0===S(this,"object"),"expected #{this} to be true","expected #{this} to be false",!S(this,"negate"))}),N.addProperty("false",function(){this.assert(!1===S(this,"object"),"expected #{this} to be false","expected #{this} to be true",!!S(this,"negate"))}),N.addProperty("null",function(){this.assert(null===S(this,"object"),"expected #{this} to be null","expected #{this} not to be null")}),N.addProperty("undefined",function(){this.assert(void 0===S(this,"object"),"expected #{this} to be undefined","expected #{this} not to be undefined")}),N.addProperty("NaN",function(){this.assert(t.isNaN(S(this,"object")),"expected #{this} to be NaN","expected #{this} not to be NaN")}),N.addProperty("exist",function(){var e=S(this,"object");this.assert(null!==e&&void 0!==e,"expected #{this} to exist","expected #{this} to not exist")}),N.addProperty("empty",function(){var e,s=S(this,"object"),o=S(this,"ssfi"),a=S(this,"message");switch(a=a?a+": ":"",t.type(s).toLowerCase()){case"array":case"string":e=s.length;break;case"map":case"set":e=s.size;break;case"weakmap":case"weakset":throw new D(a+".empty was passed a weak collection",void 0,o);case"function":var i=a+".empty was passed a function "+t.getName(s);throw new D(i.trim(),void 0,o);default:if(s!==Object(s))throw new D(a+".empty was passed non-string primitive "+t.inspect(s),void 0,o);e=Object.keys(s).length}this.assert(0===e,"expected #{this} to be empty","expected #{this} not to be empty")}),N.addProperty("arguments",r),N.addProperty("Arguments",r),N.addMethod("equal",n),N.addMethod("equals",n),N.addMethod("eq",n),N.addMethod("eql",h),N.addMethod("eqls",h),N.addMethod("above",d),N.addMethod("gt",d),N.addMethod("greaterThan",d),N.addMethod("least",c),N.addMethod("gte",c),N.addMethod("below",p),N.addMethod("lt",p),N.addMethod("lessThan",p),N.addMethod("most",l),N.addMethod("lte",l),N.addMethod("within",function(e,s,o){o&&S(this,"message",o);var a=S(this,"object"),i=S(this,"doLength"),r=S(this,"message"),n=r?r+": ":"",h=S(this,"ssfi"),d=t.type(a).toLowerCase(),c=t.type(e).toLowerCase(),p=t.type(s).toLowerCase(),l=!0,u="date"===c&&"date"===p?e.toUTCString()+".."+s.toUTCString():e+".."+s;if(i&&new N(a,r,h,!0).to.have.property("length"),i||"date"!==d||"date"===c&&"date"===p)if("number"===c&&"number"===p||!i&&"number"!==d)if(i||"date"===d||"number"===d)l=!1;else{var b="string"===d?"'"+a+"'":a;errorMessage=n+"expected "+b+" to be a number or a date"}else errorMessage=n+"the arguments to within must be numbers";else errorMessage=n+"the arguments to within must be dates";if(l)throw new D(errorMessage,void 0,h);if(i){var f=a.length;this.assert(f>=e&&f<=s,"expected #{this} to have a length within "+u,"expected #{this} to not have a length within "+u)}else this.assert(a>=e&&a<=s,"expected #{this} to be within "+u,"expected #{this} to not be within "+u)}),N.addMethod("instanceof",u),N.addMethod("instanceOf",u),N.addMethod("property",b),N.addMethod("ownProperty",f),N.addMethod("haveOwnProperty",f),N.addMethod("ownPropertyDescriptor",g),N.addMethod("haveOwnPropertyDescriptor",g),N.addChainableMethod("length",x,m),N.addChainableMethod("lengthOf",x,m),N.addMethod("match",v),N.addMethod("matches",v),N.addMethod("string",function(e,s){s&&S(this,"message",s);var o=S(this,"object"),a=S(this,"message"),i=S(this,"ssfi");new N(o,a,i,!0).is.a("string"),this.assert(~o.indexOf(e),"expected #{this} to contain "+t.inspect(e),"expected #{this} to not contain "+t.inspect(e))}),N.addMethod("keys",w),N.addMethod("key",w),N.addMethod("throw",y),N.addMethod("throws",y),N.addMethod("Throw",y),N.addMethod("respondTo",M),N.addMethod("respondsTo",M),N.addProperty("itself",function(){S(this,"itself",!0)}),N.addMethod("satisfy",j),N.addMethod("satisfies",j),N.addMethod("closeTo",k),N.addMethod("approximately",k),N.addMethod("members",function(e,s){s&&S(this,"message",s);var o=S(this,"object"),a=S(this,"message"),i=S(this,"ssfi");new N(o,a,i,!0).to.be.an("array"),new N(e,a,i,!0).to.be.an("array");var r,n,h,d=S(this,"contains"),c=S(this,"ordered");d?(r=c?"an ordered superset":"a superset",n="expected #{this} to be "+r+" of #{exp}",h="expected #{this} to not be "+r+" of #{exp}"):(r=c?"ordered members":"members",n="expected #{this} to have the same "+r+" as #{exp}",h="expected #{this} to not have the same "+r+" as #{exp}");var p=S(this,"deep")?t.eql:void 0;this.assert(O(e,o,p,d,c),n,h,e,o,!0)}),N.addMethod("oneOf",C),N.addMethod("change",P),N.addMethod("changes",P),N.addMethod("increase",E),N.addMethod("increases",E),N.addMethod("decrease",L),N.addMethod("decreases",L),N.addMethod("by",q),N.addProperty("extensible",function(){var e=S(this,"object"),t=e===Object(e)&&Object.isExtensible(e);this.assert(t,"expected #{this} to be extensible","expected #{this} to not be extensible")}),N.addProperty("sealed",function(){var e=S(this,"object"),t=e!==Object(e)||Object.isSealed(e);this.assert(t,"expected #{this} to be sealed","expected #{this} to not be sealed")}),N.addProperty("frozen",function(){var e=S(this,"object"),t=e!==Object(e)||Object.isFrozen(e);this.assert(t,"expected #{this} to be frozen","expected #{this} to not be frozen")}),N.addProperty("finite",function(e){var t=S(this,"object");this.assert("number"==typeof t&&isFinite(t),"expected #{this} to be a finite number","expected #{this} to not be a finite number")})}},{}],17:[function(require,module,exports){/*!
 * chai
 * Copyright(c) 2011-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
