...
var Runnable=require("./runnable"),Hook=require("./hook"),state=require("./state"),hooks={};["before","after","beforeEach","afterEach"].forEach(function(e){var r=hooks[e]=new Hook(e);globals[e]=r.push.bind(r),globals[e].pop=r.pop.bind(r),globals[e].clear=r.clear.bind(r),globals[e].count=r.count.bind(r)}),globals.describe=function(e,r){0===state.stack.length&&(state.reset(),hooks.before.run());var o=new Runnable("describe",e,r);return o.run(),0===state.stack.length&&hooks.after.run(),state.results},globals.it=function(e,r){hooks.beforeEach.run();var o=new Runnable("it",e,r);return o.run(),hooks.afterEach.run(),o.result};
...
require("./_prelude"),require("./bdd"),module.exports=require("./options"),globals.response=require("./response"),globals.chai=require("chai"),globals.chai.should(),globals.assert=globals.chai.assert,globals.expect=globals.chai.expect;var assertions=require("./assertions");globals.chai.use(assertions);
