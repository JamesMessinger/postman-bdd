...
(function (process){
"use strict";function detectNewman(){return!process.browser}function detectChromeApp(){return process.browser}function detectElectronApp(){return process.browser}function detectRequestBuilder(){return process.browser&&window.parent&&window.parent.document&&"function"==typeof window.parent.document.querySelector&&!!window.parent.document.querySelector("#request-builder-view")}function detectCollectionRunner(){return!detectRequestBuilder()}module.exports={newman:detectNewman(),chrome:detectChromeApp(),electron:detectElectronApp(),requestBuilder:detectRequestBuilder(),collectionRunner:detectCollectionRunner()};
