...
(function (global){
"use strict";require("./_prelude"),require("./bdd"),module.exports=require("./options"),global.chai=require("chai"),global.chai.should(),global.assert=chai.assert,global.expect=chai.expect;var assertions=require("./assertions");chai.use(assertions);
...
function Response(){this.text=getText(),this.body=getBody(),this.header=getHeaders(),this.time=getTime(),this.status=getStatus(),this.statusType=getStatusType(),this.info=1===this.statusType,this.ok=2===this.statusType,this.clientError=4===this.statusType,this.serverError=5===this.statusType,this.error=this.clientError||this.serverError,this.accepted=202===this.status,this.noContent=204===this.status||1223===this.status,this.badRequest=400===this.status,this.unauthorized=401===this.status,this.notAcceptable=406===this.status,this.notFound=404===this.status,this.forbidden=403===this.status;var t=this.getHeader("content-type")||"";this.type=getType(t),this.charset=getCharset(t)}function getText(){return"string"==typeof responseBody?responseBody:""}function getBody(){var t=getText();try{return JSON.parse(t)}catch(e){return{}}}function getHeaders(){return"object"==typeof responseHeaders?responseHeaders:{}}function getTime(){return"number"==typeof responseTime?responseTime:0}function getType(t){return t.split(";")[0]}function getCharset(t){var e=/charset=([a-zA-Z0-9_-]+)/i.exec(t);return e?e[1]:""}function getStatus(){return"object"==typeof responseCode?responseCode.code:0}function getStatusType(){return Math.floor(getStatus()/100)}function getPostman(){return"object"==typeof postman?postman:postmanProxy}module.exports=Response,Response.prototype.getHeader=function(t){return t=t.toLowerCase(),getPostman().getResponseHeader(t)||this.header[t]},Response.prototype.getCookie=function(t){return getPostman().getResponseCookie(t)};var postmanProxy={getEnvironmentVariable:function(){},setEnvironmentVariable:function(){},getGlobalVariable:function(){},setGlobalVariable:function(){},getResponseHeader:function(){},getResponseCookie:function(){}};
...
(function (global){
"use strict";var Response=require("./response"),state=module.exports={response:new Response,results:"object"==typeof tests?tests:{},stack:[],counters:{describe:0,it:0,before:0,after:0,beforeEach:0,afterEach:0},inAHook:function(){return this.stack.some(function(e){return e.isHook})},reset:function(){var e=this;global.response=e.response=new Response,Object.keys(this.results).length>0&&(e.results={}),Object.keys(this.counters).forEach(function(t){e.counters[t]=0})}};state.stack.toString=function(){return this.map(function(e){return e.title}).join(" ")};
