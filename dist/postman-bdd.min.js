...
(function (global){
"use strict";require("./_prelude"),require("./bdd");var chai=require("chai");chai.should(),global.assert=chai.assert,global.expect=chai.expect;

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./_prelude":1,"./bdd":2,"chai":12}],5:[function(require,module,exports){
(function (process){
"use strict";function detectNewman(){return"object"==typeof process}function detectChromeApp(){return detectBrowser()}function detectElectronApp(){return detectBrowser()}function detectRequestBuilder(){return detectBrowser()&&window.parent&&window.parent.document&&"function"==typeof window.parent.document.querySelector&&!!window.parent.document.querySelector("#request-builder-view")}function detectCollectionRunner(){return!detectRequestBuilder()}function detectBrowser(){return"object"==typeof window}module.exports={newman:detectNewman(),chrome:detectChromeApp(),electron:detectElectronApp(),requestBuilder:detectRequestBuilder(),collectionRunner:detectCollectionRunner()};

}).call(this,require('_process'))

},{"_process":46}],6:[function(require,module,exports){
"use strict";function Runnable(t,s,e){"function"==typeof s&&(e=s,s=""),this.type=t,this.isHook=!1,this.title=s,this.fn=e,this.result=null,this.error=null}var postman=require("./postman"),state=require("./state");module.exports=Runnable,Runnable.prototype.run=function(){state.counters[this.type]++,this.title=this.title||("it"===this.type?"test":this.type)+" #"+state.counters[this.type],state.stack.push(this);var t=state.stack.toString();postman.newman||console.log("Running "+t);try{this.fn(),this.success(t)}catch(s){this.failure(s,t)}finally{state.stack.pop()}},Runnable.prototype.success=function(t){this.result=!0,"it"===this.type&&(state.results[t||this.title]=!0)},Runnable.prototype.failure=function(t,s){if(postman.newman||console.error(t),this.result=!1,this.error=t,state.results[s||this.title]=!1,state.results[t.message]=!1,postman.requestBuilder)throw t};
