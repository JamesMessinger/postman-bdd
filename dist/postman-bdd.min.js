...
(function (global){
require("./_prelude"),require("./bdd"),module.exports=require("./options"),response=require("./response"),console.log("This: "+typeof this),console.log("Global: "+typeof global),console.log("Window: "+typeof window),chai=require("chai"),chai.should(),assert=chai.assert,expect=chai.expect;var assertions=require("./assertions");chai.use(assertions);
