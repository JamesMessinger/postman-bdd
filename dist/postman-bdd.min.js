...
var Runnable=require("./runnable"),Hook=require("./hook"),runtime=require("./runtime"),state=require("./state"),hooks={};["before","after","beforeEach","afterEach"].forEach(function(e){var r=hooks[e]=new Hook(e);runtime.global[e]=r.push.bind(r),runtime.global[e].pop=r.pop.bind(r),runtime.global[e].clear=r.clear.bind(r),runtime.global[e].count=r.count.bind(r)}),describe=function(e,r){0===state.stack.length&&(state.reset(),hooks.before.run());var n=new Runnable("describe",e,r);return n.run(),0===state.stack.length&&hooks.after.run(),state.results},it=function(e,r){hooks.beforeEach.run();var n=new Runnable("it",e,r);return n.run(),hooks.afterEach.run(),n.result};
...
require("./_prelude"),require("./bdd"),module.exports=require("./options"),response=require("./response"),chai=require("chai"),assert=chai.assert,expect=chai.expect,chai.should();var assertions=require("./assertions");chai.use(assertions);
...
"use strict";function Runnable(t,s,e){"function"==typeof s&&(e=s,s=""),this.type=t,this.isHook=!1,this.title=s,this.fn=e,this.result=null,this.error=null}var state=require("./state"),options=require("./options");module.exports=Runnable,Runnable.prototype.run=function(){state.counters[this.type]++,this.title=this.title||("it"===this.type?"test":this.type)+" #"+state.counters[this.type],state.stack.push(this);var t=state.stack.toString();options.log&&console.log("Running "+t);try{this.fn(),this.success(t)}catch(s){this.failure(s,t)}finally{state.stack.pop()}},Runnable.prototype.success=function(t){this.result=!0,"it"===this.type&&(state.results[t||this.title]=!0)},Runnable.prototype.failure=function(t,s){options.log&&("function"==typeof console.error?console.error(t):console.log(t)),options.debug,this.result=!1,this.error=t,state.results[s||this.title]=!1,state.results[t.message]=!1};

},{"./options":6,"./state":10}],9:[function(require,module,exports){
(function (global){
"use strict";function detectNewman(){return!detectBrowser()&&!global.process}function detectChromeApp(){return detectBrowser()&&!getParentDocument()}function detectElectronApp(){return detectBrowser()&&!!getParentDocument()}function detectRequestBuilder(){return detectElectronApp()&&!!window.parent.document.querySelector(".requester-builder")}function detectCollectionRunner(){return!detectRequestBuilder()}function detectBrowser(){return"object"==typeof window}function getParentDocument(){try{return window.parent.document}catch(e){return null}}module.exports={global:detectNewman()?this:global,newman:detectNewman(),chrome:detectChromeApp(),electron:detectElectronApp(),requestBuilder:detectRequestBuilder(),collectionRunner:detectCollectionRunner()};

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{}],10:[function(require,module,exports){
"use strict";var state=module.exports={results:"object"==typeof tests?tests:{},stack:[],counters:{describe:0,it:0,before:0,after:0,beforeEach:0,afterEach:0},inAHook:function(){return this.stack.some(function(t){return t.isHook})},reset:function(){var t=this,e="object"==typeof tests?tests:{};Object.keys(e).forEach(function(t){delete e[t]}),t.results=e,Object.keys(this.counters).forEach(function(e){t.counters[e]=0})}};state.stack.toString=function(){return this.map(function(t){return t.title}).join(" ")};
